connect('weblogic','gumby1234','t3://wls0-ejb102801-ejb102801.eastus.cloudapp.azure.com:7001')
edit("edburns-surface")
startEdit()
cd('/')
try:
...
destroyEditSession("edburns-surface",force = true)
disconnect()
